...
while es_valido_telefono:
   telefono = input("Ingrese el telefono unico: ")
   es_valido_telefono = validar_telefono_unico(telefono, contactos)
...
contactos = leer_contactos() #recargar la lista (actualizar)
nombre_buscar = input("Ingrese el nombre a buscar del contacto: ")
buscar_contacto(nombre_buscar, contactos)